...
void Robot::RobotInit() {
    ...
    autoModes.AddDefault("auto builder",new AutoBuilder());
	autoModes.AddObject("Autonomous Command 1", new AutonomousCommand());
    autoModes.AddObject("dont do anything",new DontDoAnything());
    autoModes.AddObject("drive forward(timed)",new DumbDriveForward());
    autoModes.AddObject("drive forward(gyro+encoder)", new DriveForwardGyroEncoder(48.0));
    autoModes.AddObject("drive forward (profiled)",new DriveForward(48.0));
    ...
    field = std::make_unique<FieldModel>();
}
