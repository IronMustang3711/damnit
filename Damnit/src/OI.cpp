...
OI::OI( Commands& commands) {
	...
	ds_clampToggle->WhenPressed(static_cast<Command*>(&commands.clampToggle));
	...
	toggleClamp->WhenPressed(static_cast<Command*>(&commands.clampToggle));//(new ClampPosition(-1));// toggle special see clampPosition.cpp
