...
OI::OI( Commands& commands) {
	...
	ds_clampToHome->WhenPressed(new StowClamp);
	...
	winchUp->WhenReleased(&commands.winchHold);
	...
	winchStop->WhileHeld(&commands.winchDisable);
	...
	dwinchUp->WhenReleased(&commands.winchHold);
	...
	dwinchStop->WhenPressed(&commands.winchDisable);
