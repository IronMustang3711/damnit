...
class AbstractClampCommand : public frc::Command {
protected:
    explicit AbstractClampCommand(std::string name,double timeout = 0.5);
...
class ClampOpen : public AbstractClampCommand {
public:
    ClampOpen();
...
class ClampClose : public AbstractClampCommand {
public:
    ClampClose();
