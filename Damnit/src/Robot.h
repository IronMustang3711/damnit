...
private:
    ...
    autoModes.AddObject("drive forward(gyro+encoder)", new DriveForwardGyroEncoder());
    autoModes.AddObject("drive forward (profiled)",new DriveForward());
     */
	...
	frc::SendableChooser<AutoMode> autoModes;
