...
std::shared_ptr<frc::Solenoid> RobotMap::lightsRed;
std::shared_ptr<frc::Solenoid> RobotMap::lightsGreen;
std::shared_ptr<frc::Solenoid> RobotMap::lightsBlue;
...
void RobotMap::init() {
	...
	frc::LiveWindow::GetInstance()->DisableTelemetry(subsystem1PowerDistributionPanel1.get());

	lightsRed.reset(new frc::Solenoid(0,0));
	lightsRed->SetName("Red Lights");

	lightsGreen.reset(new frc::Solenoid(0,1));
	lightsGreen->SetName("Green Lights");

	lightsBlue.reset(new frc::Solenoid(0,2));
	lightsBlue->SetName("BlueLights");
	...
	ahrs.reset(new AHRS(frc::SPI::Port::kMXP,200));
